...
//		}
	...
	public static Object ObjectField (GUIContent label, GameObject value, object callingObj)
	{
		UnityEditor.EditorGUIUtility.labelWidth = 100;
		return UnityEditor.EditorGUILayout.ObjectField(label, (Object)value, typeof(GameObject));
	}

	public static Object ObjectField ( GameObject value, object callingObj)
	{
		UnityEditor.EditorGUIUtility.labelWidth = 100;
		return UnityEditor.EditorGUILayout.ObjectField((Object)value, typeof(GameObject));
	}
}
