...
#ifdef CRT_2D
				float3 noise = GenerateCellular2DNoise(uvs, _Frequency, _Octaves, _Persistance, _Lacunarity).rgb;

#else
				float3 noise = GenerateCellular3DNoise(uvs, _Frequency, _Octaves, _Persistance, _Lacunarity).rgb;
#endif
