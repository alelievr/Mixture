...
namespace Mixture
{
    interface IMipMapSubShader : ISubShader
    {

    }

    [Serializable]
    class MipMapSubShader : IMipMapSubShader
    {
        readonly string customTextureTemplateGUID = "e2bd3f2f69902b64c8cd77ba7948c1b9";

        string GenerateGraph(MipMapMasterNode masterNode, string template)
        {
            // ----------------------------------------------------- //
            //                         SETUP                         //
            // ----------------------------------------------------- //
        ...
        string ISubShader.GetSubshader(IMasterNode iMasterNode, GenerationMode mode, List<string> sourceAssetDependencyPaths)
        {
            ...
            {
                sourceAssetDependencyPaths.Add(AssetDatabase.GUIDToAssetPath("5b2d4724a38a5485ba5e7dc2f7d86f1a")); // MipMapSubShader.cs
            ...
            return GenerateGraph(iMasterNode as MipMapMasterNode, templateCode);
            ...
            // var masterNode = iMasterNode as MipMapMasterNode;
