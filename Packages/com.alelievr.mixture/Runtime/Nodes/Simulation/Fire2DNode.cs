...
namespace Mixture
{
	...
	public class Fire2DNode : BaseFluidSimulationNode 
	{
		...
		RenderTexture[] m_density, m_velocity, m_pressure, m_temperature, m_reaction;
		[SerializeField, HideInInspector]
        ...
        protected override void Enable()
        {
			...
			m_reaction[READ] = AllocateRenderTexture("reactionR", GraphicsFormat.R16_SFloat);
			m_reaction[WRITE] = AllocateRenderTexture("reactionW", GraphicsFormat.R16_SFloat);
		...
		protected override bool ProcessNode(CommandBuffer cmd)
		{
			...
			outputTemperature = m_temperature[READ];
            outputReaction = m_reaction[READ];
            ...
            ApplyAdvection(cmd, m_reactionDecay, 1.0f, m_reaction, m_velocity[READ], m_obstacles);
            ...
            ApplyBuoyancy(cmd, m_temperature[READ], m_velocity, m_densityBuoyancy, m_ambientTemperature);
			...
			InjectDensity(cmd, m_reactionAmount, inputReaction, m_reaction);
            ...
            ApplyExtinguishmentImpulse(cmd, m_densityAmount, m_reaction[READ], m_density, m_reactionExtinguishment);
