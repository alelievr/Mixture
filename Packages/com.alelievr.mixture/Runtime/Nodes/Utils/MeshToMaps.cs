...
")]
	...
	[System.Serializable, NodeMenuItem("Custom/Mesh To Maps"), NodeMenuItem("Custom/Extract Mesh Maps")]
	public class MeshToMaps : MixtureNode 
	{
		...
		[Input, Tooltip("The mesh from where the attributes will be extracted")]
		...
		{
            if (!base.ProcessNode(cmd) || mesh == null)
                return false;
